...
const I18N = {
  fr: {
    ...
    "footer.copyright": "&copy; <strong>2026</strong> S.O.S Abeilles Guyane.",
  ...
  en: {
    ...
    "nid.subtitle": "Hover over the different areas to discover the spots around the house where swarms most often settle.",
    ...
    "nid.hotspot2.tip": "False ceilings and attics<br><small>dark and dry, up high</small>",
    "nid.hotspot3.aria": "Abandoned buckets and tyres: mainly dry and sheltered from rain",
    "nid.hotspot3.tip": "Buckets and old tyres<br><small>dry, sheltered from rain</small>",
    "nid.hotspot4.aria": "Water or electricity meters: their protected cavity is ideal",
    "nid.hotspot4.tip": "Water or electricity meters<br><small>ideal protected cavity</small>",
    "nid.hotspot5.aria": "Cardboard boxes and empty crates: left outside or in a garden shed",
    "nid.hotspot5.tip": "Boxes and empty crates<br><small>garden shed and garage</small>",
    ...
    "zone.mapNote": "Real OpenStreetMap map: the honey-coloured circle shows the overall service area, from Macouria to Roura, as a rough guide only.",
  ...
  es: {
    ...
    "nid.subtitle": "Pase el cursor sobre las diferentes zonas para descubrir los lugares de la casa donde suelen instalarse los enjambres.",
    ...
    "nid.hotspot2.tip": "Falsos techos y áticos<br><small>oscuro y seco, en altura</small>",
    "nid.hotspot3.aria": "Cubos y neumáticos abandonados: sobre todo secos y protegidos de la lluvia",
    "nid.hotspot3.tip": "Cubos y neumáticos<br><small>secos, sin lluvia</small>",
    "nid.hotspot4.aria": "Contadores de agua o de electricidad: su cavidad protegida es ideal",
    "nid.hotspot4.tip": "Contadores de agua o de electricidad<br><small>cavidad protegida ideal</small>",
    "nid.hotspot5.aria": "Cajas de cartón y cajones vacíos: dejados afuera o en un cobertizo",
    "nid.hotspot5.tip": "Cajas y cajones vacíos<br><small>cobertizo y garaje</small>",
    ...
    "zone.mapNote": "Mapa real de OpenStreetMap: el círculo color miel indica la zona de intervención general, de Macouria a Roura, a título indicativo.",
  ...
  pt: {
    ...
    "nid.subtitle": "Passe o cursor sobre as diferentes áreas para descobrir os locais da casa onde os enxames mais costumam se instalar.",
    ...
    "nid.hotspot2.tip": "Forros e sótãos<br><small>escuro e seco, em altura</small>",
    "nid.hotspot3.aria": "Baldes e pneus abandonados: geralmente secos e protegidos da chuva",
    "nid.hotspot3.tip": "Baldes e pneus velhos<br><small>secos, sem chuva</small>",
    "nid.hotspot4.aria": "Medidores de água ou de eletricidade: sua cavidade protegida é ideal",
    "nid.hotspot4.tip": "Medidores de água ou de eletricidade<br><small>cavidade protegida ideal</small>",
    "nid.hotspot5.aria": "Caixas de papelão e caixotes vazios: deixados fora ou em um galpão de jardim",
    "nid.hotspot5.tip": "Caixas e caixotes vazios<br><small>galpão e garagem</small>",
    ...
    "zone.mapNote": "Mapa real do OpenStreetMap: o círculo cor de mel indica a área de atuação geral, de Macouria a Roura, apenas a título indicativo.",
  ...
  zh: {
    ...
    "nid.title": "蜂群喜欢安家的地方",
    "nid.subtitle": "将鼠标悬停在不同区域上,了解房屋中蜂群最常安家的位置。",
    ...
    "nid.hotspot2.tip": "吊顶和阁楼<br><small>高处干燥阴暗</small>",
    "nid.hotspot3.aria": "废弃的桶和轮胎:干燥且可避雨",
    "nid.hotspot3.tip": "废弃桶和轮胎<br><small>干燥、可避雨</small>",
    "nid.hotspot4.aria": "水表或电表:其保护空腔非常理想",
    "nid.hotspot4.tip": "水表或电表<br><small>理想的保护空腔</small>",
    "nid.hotspot5.aria": "空纸箱和箱子:放在室外或花园棚里的",
    "nid.hotspot5.tip": "纸箱和空箱子<br><small>花园棚和车库</small>",
    "zone.title": "服务区域",
    "zone.subtitle": "本服务覆盖CACL(中央沿海城市群)辖区。",
    "zone.mapAria": "服务区域地图:卡宴、雷米尔蒙乔利、马图里、马库里亚、蒙西内里-通尼格朗德和鲁拉",
    "zone.mapNote": "真实的OpenStreetMap地图:蜂蜜色圆圈仅作参考,标示从马库里亚到鲁拉的整体服务范围。",
    "steps.title": "运作方式",
